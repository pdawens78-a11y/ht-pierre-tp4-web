package htpierretp4web.jsf;

import htpierretp4web.llm.LlmClient;
...
public class Bb implements Serializable {
    ...
    public List<SelectItem> getRolesSysteme() {
        if (this.listeRolesSysteme == null) {
            ...
            role = """
                    You are a comedian. You answer in a humorous, playful and lighthearted way.
                    Keep the tone witty, but still helpful and relevant to the user's question.
                    """;
